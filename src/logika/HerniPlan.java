...
public class HerniPlan implements Subject{
    ...
    private void zalozLokaceHry() {
        ...
        Lokace domov = new Lokace("domov","dům, ve kterém bydlí Luigi",50,60);
        Lokace ulice = new Lokace("ulice", "ulice, vede okolo Luigiho domu",56,50); 
        Lokace obchod = new Lokace("obchod","klasická večerka, je to tam jen pár metrů od domova",60,80);
        Lokace pestirna = new Lokace("pestirna", "pěstírna, co od majitele večerky jiného čekat",70,60);
        Lokace hlavni = new Lokace("hlavni","nejrušnější ulice ve městě",120,60); 
        Lokace pizzerie = new Lokace("pizzerie","Pizzerie, ve které pracuješ",90,80);
        Lokace satna = new Lokace("satna","Obyčejná šatna, sem si dáváš věci",75,85);
        Lokace metro = new Lokace("metro","Staré komančské metro, odpadky kam šlápneš\nkdyž ale odjedeš metrem na trase C\nUŽ SE NELZE VRÁTIT ZPĚT!!!\nzpáteční trasa je zaplavena.",60,55);
        Lokace stanice = new Lokace("stanice", "Stanice, Po půl hodině jsi dojel na konečnou stanici",85,75);
        Lokace banka = new Lokace("banka","Banka, Vlastní ji Krejčíř, měj se na pozoru! ",23,65);
        Lokace nemocnice = new Lokace("nemocnice","Motol, Ošklivý zápach všude kolem, ale snad ti tu pomůžou",52,87);
        Lokace ukryt = new Lokace("ukryt","Bunker, Zajímavá stavba u silnice, třeba tam něco najdeš",12,89);
        Lokace azyl = new Lokace("azyl","Asylum, Něco jako psychiatrická léčebna, něco by jsi tam ale mohl ukrást\nvedou jej jeptišky, nejsou podezíravé",160,52);
        Lokace les = new Lokace("les","Falndyr, Temný hvozd, pozor na dravá zvířata a loupežníky",89,55);
        Lokace radnice = new Lokace("radnice","Radnice, Klasická byrokratická stavba",65,25);
